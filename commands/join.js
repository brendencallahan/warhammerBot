...
module.exports = {
  ...
  verbose:
    "Typing `!join` will have me join whatever voice channel you're currently in. " +
    ...
    if (args[0]) {
      try {
        ...
        return message.channel.send(
          `${client.emotes.error} | Heretic! ${args[0]} is not valid. Your heresy will be remembered!`
        );
      }
